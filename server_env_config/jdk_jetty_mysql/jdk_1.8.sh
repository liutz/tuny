...
JDK_FILE="$DOWNLOAD_DIR/jdk-8u77-linux-x64.tar.gz"
JDK_DURL="http://download.oracle.com/otn-pub/java/jdk/8u77-b03/jdk-8u77-linux-x64.tar.gz"
JDK_INSTALL_DIR="/usr/local/java"
JDK_ROOT_FOLDER="jdk1.8.0_77"
